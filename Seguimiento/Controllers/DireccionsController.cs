...
namespace Seguimiento.Controllers
{
    public class DireccionsController : Controller
    {
        ...
        public DireccionsController(SeguimientoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,provicia,calle,numero,localidad")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,provicia,calle,numero,localidad")] Direccion direccion)
        {
            if (id != direccion.id)
            {
                return NotFound();
